Public Class rptAccountLedger
    ...
    Private Sub GroupHeader1_BeforePrint(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles GroupHeader1.BeforePrint
        XrOpeningBal.Text = 0
        Opening = Val(DBManger.XtraTableColumnValue("isNull(Sum(Credit-Debit),0)", String.Format("vwAccountsLedger WHERE AccountID= '{0}' and EntryDate < '{1}'", Me.GetCurrentColumnValue("AccountID"), OpeningBalanceDate)))
