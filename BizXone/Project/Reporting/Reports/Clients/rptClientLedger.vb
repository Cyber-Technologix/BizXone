...
Public Class rptClientLedger
    ...
    Private Sub rptClientLedger_BeforePrint(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles MyBase.BeforePrint
